"""
Django settings for chets_42347 project.
...
WSGI_APPLICATION = 'chets_42347.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chets_42347 API",
    "DESCRIPTION": "API documentation for chets_42347 App",
    "VERSION": "v1",
}
